...
public partial class teacher_afterlogin_EditProfile : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["course_teacherid"] != null)
        {
            ...
            if (!IsPostBack)
            {
                string query = "SELECT * FROM Teachermaster WHERE EmailId='" + Session["EmailId"] + "'";
    ...
    {
        string update = "UPDATE Teachermaster SET Firstname='" + FN.Text + "',Lastname='" + LN.Text + "',Password='" + password.Text + "',Confirm_Password='" + cpassword.Text + "',Contactnumber='" + contactno.Text + "',State='" + state.Text + "',City='" + city.Text + "' WHERE EmailId='" + Session["EmailId"] + "'";
